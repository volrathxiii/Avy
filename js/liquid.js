...
(function () {
    function C() {
        ...
        u = q;
        v = r;
        for (var d = 0.86 * f, l = 0.125 * f, m = 0.15 * f, t = Math.random, n = Math.abs, o = z; o--; ) {
            var h = A[o], i = h.x, j = h.y, a = h.a, b = h.b, c = i - q, k = j - r, g = Math.sqrt(c * c + k * k) || 0.001, c = c / g, k = k / g;
            if (w && g < m)
                var s = 7 * (1 - g / m), a = a + (c * s + 0.5 - t()), b = b + (k * s + 0.5 - t());
